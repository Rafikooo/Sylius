...
final class OrdersTest extends JsonApiTestCase
{
    ...
    {
        $this->setUpDefaultGetHeaders();$this->loadFixturesFromFile('channel.yaml');
    ...
    public function it_returns_nothing_if_visitor_tries_to_get_the_items_of_a_user_order(): void
    {
        ...
        $this->assertResponse($this->client->getResponse(), 'shop/order/get_empty_order_items');
    }
